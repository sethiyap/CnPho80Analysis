...
5. Cells were treated with 1μg/ml rapamycin and equal amount of DMSO
as control
...
9. qPCR of genes commonly induced or down-regulated in
pho80Δ/WT and
WT+rapa/WT RNASeq data

ΔΔCt and fold change calculation
Housekeeping gene: ACT1 (actin)
Gene of Interest: ABC
ΔCt: Ct value ABC - Ct value ACT1
Avg ΔCt: Average of ΔCt control (WT)
ΔΔCt: ΔCt - Avg ΔCt
Foldchange: 2^-ΔΔCt
...
rapa_FC <- compute_qPCR_foldchange(dat_qPCR = rapa_qPCR, house_keeping = "ACT1", control = "WT",treatment = c("WT+Rapa"), return_pval = FALSE)

plot_qPCR_foldchange(fc_tibble = rapa_FC, display_pval = FALSE, control_group = "pho80",nrow = 1)
